@tool
class_name HenActionIsOnCeiling3D extends HenScriptMacroBase
...
func get_flow_outputs() -> Array[Dictionary]:
	return [
		{name = 'True', id = &'true', doc = 'Where to go when the body touches the ceiling.'},

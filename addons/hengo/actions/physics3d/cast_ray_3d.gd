...
func get_outputs() -> Array[Dictionary]:
	return [
		...
		{name = 'Point', type = 'Vector3', id = &'point', doc = 'The global position where the line touched it.'},
		{name = 'Normal', type = 'Vector3', id = &'normal', doc = 'The direction the touched surface faces.'}
	]
...
func _body() -> String:
	return 'var skip_{{VCNODE_ID}}: Array[RID] = []\n' \
		+ 'if {{ignore_self}} and _ref is CollisionObject3D:\n' \

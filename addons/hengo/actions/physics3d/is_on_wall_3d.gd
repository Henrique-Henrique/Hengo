@tool
class_name HenActionIsOnWall3D extends HenScriptMacroBase
...
func get_id() -> StringName:
	return &'is_on_wall_3d'


func get_description() -> String:
	return 'Checks whether the body pressed against a wall and branches on the result. It uses the wall contact from the last Move And Slide.'

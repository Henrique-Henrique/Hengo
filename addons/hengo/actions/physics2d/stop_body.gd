@tool
class_name HenActionStopBody extends HenScriptMacroBase


# zeroes both the linear and the angular velocity of a rigid body in one step,
# the pair a reset or respawn always needs to bring the body fully to rest. in 2d
# the angular velocity is a single number.

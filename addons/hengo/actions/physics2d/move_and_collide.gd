...
func get_outputs() -> Array[Dictionary]:
	return [
		...
		{name = 'Point', type = 'Vector2', id = &'point', doc = 'The position where the contact happened.'},
		{name = 'Normal', type = 'Vector2', id = &'normal', doc = 'The direction the hit surface faces.'}
	]

...
func get_description() -> String:
	return 'Briefly tints a node toward a color and back, the flash a character shows when it takes damage. Runs once when the state starts. Wire Finished and the flow moves on by itself when it ends, with no timer of your own.'

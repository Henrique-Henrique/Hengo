...
static func get_var_code_base(_type: StringName, _export: bool, _custom_name: String = '', _preview_id: String = '', _default_value: Variant = null) -> String:
	var var_code: String = ''
...
static func get_var_code_from_var(_var_data: HenSaveVar) -> String:
	return get_var_code_base(_var_data.type, _var_data.is_export, _var_data.name, '', _var_data.default_value)
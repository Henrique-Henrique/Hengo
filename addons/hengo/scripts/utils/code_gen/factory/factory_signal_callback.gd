class_name HenFactorySignalCallback extends RefCounted


static func get_signal_from_dict(_signal_data: Dictionary, _refs: HenTypeReferences) -> HenTypeSignalCallbackData:
	var signal_item: HenTypeSignalCallbackData = HenTypeSignalCallbackData.new()
	...
	_refs.signals_callback.append(signal_item)

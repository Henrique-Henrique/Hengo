#[hengo] {"comments":[],"connections":[],"debug_symbols":{"2":[1],"4":[2,"cnode"],"8":[1]},"flow_connections":[{"from_cnode":2,"from_connector":0,"to_cnode":4}],"func_item_list":[],"local_var_items":[],"node_counter":4,"signal_item_list":[],"state_name_counter":1,"states":[{"cnode_list":[{"hash":2,"inputs":[],"name":"enter","outputs":[],"pos":"Vector2(123.057, -8.00369)","sub_type":"virtual"},{"hash":3,"inputs":[],"name":"update","outputs":[{"name":"delta","type":"float"}],"pos":"Vector2(799.192, -5.95796)","sub_type":"virtual"},{"category":"native","hash":4,"inputs":[{"in_prop":"dsadas","name":"content","type":"String"}],"name":"print","outputs":[],"pos":"Vector2(62.4168, 192.193)","sub_type":"void"}],"events":[{"name":"Start","type":"start"}],"id":1,"name":"State Name 1","pos":"Vector2(0, 0)","route":{"id":"172987510906366","name":"State Name 1","type":0},"transitions":[]}],"type":"Sprite2D","var_item_list":[]}
